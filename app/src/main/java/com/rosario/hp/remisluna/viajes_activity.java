...
public class viajes_activity extends AppCompatActivity {
    ...
    private static final String TAG = viajes_activity.class.getSimpleName();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.menu_ayuda:
                ...
                editor.putString("url", "https://remisluna.com.ar/remiseria/pagina_ayuda.php?id=6");
                editor.apply();
    ...
    public void cargarAyuda(final Context context) {
        ...
        String newURL = Constantes.GET_ID_AYUDA + "?ayuda=6";
        Log.d(TAG,newURL);
