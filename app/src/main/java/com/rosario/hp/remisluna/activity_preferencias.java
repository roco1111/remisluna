...
public class activity_preferencias extends AppCompatActivity {
    ...
    private static final String TAG = activity_preferencias.class.getSimpleName();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.menu_ayuda:
                ...
                editor.putString("url", "https://remisluna.com.ar/remiseria/pagina_ayuda.php?id=9");
                editor.apply();
    ...
    public void cargarAyuda(final Context context) {
        ...
        String newURL = Constantes.GET_ID_AYUDA + "?ayuda=9";
        Log.d(TAG,newURL);
