...
public class Constantes {
    ...
    public static final String VERIFICAR_MOVIL_TURNO = "https://" + IP + PUERTO_HOST + "/verificar_movil_turno.php";
    ...
    public static final String GET_SALDO_CONDUCTOR = "https://" + IP + PUERTO_HOST + "/obtener_saldo_id_chofer.php";
    ...
    public static final String UPDATE_IMPRESORA = "https://" + IP + PUERTO_HOST + "/actualizar_impresora.php";
    ...
    public static final String NOTIFICACION = "https://" + IP + PUERTO_HOST + "/enviar_notificacion_web.php";
